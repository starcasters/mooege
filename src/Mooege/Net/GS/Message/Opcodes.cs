...
namespace Mooege.Net.GS.Message
{
    public enum Opcodes : int
    {
        ...
        PlayerKickTimerMessage = 53, // patch 14
        ...
        ANNDataMessage101 = 101, // patch 14
        ...
        UnassignSkillMessage = 108, // patch 14
        ...
        ACDTranslateAckMessage130 = 130,	//patch 14
