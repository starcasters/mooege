...
namespace D3.Hero {
  ...
  public static partial class Hero {
    ...
    static Hero() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          ...
          "aWZmaWN1bHR5GAMgAigROgEwIqEECgZEaWdlc3QSDwoHdmVyc2lvbhgBIAIo" + 
          ...
          "c3RzGAEgAygLMg8uRDMuSGVyby5EaWdlc3QiSQoQUXVlc3RIaXN0b3J5TGlz" + 
          "dBI1ChFxdWVzdF9oaXN0b3J5UHJvcBgBIAMoCzIaLkQzLkhlcm8uUXVlc3RI" + 
          "aXN0b3J5RW50cnkiOwoOU2F2ZWRRdWVzdExpc3QSKQoMc2F2ZWRfcXVlc3Rz" + 
          "GAEgAygLMhMuRDMuSGVyby5TYXZlZFF1ZXN0IlwKFlF1ZXN0UmV3YXJkSGlz" + 
          "dG9yeUxpc3QSQgoYcXVlc3RfcmV3YXJkX2hpc3RvcnlQcm9wGAEgAygLMiAu" + 
          "RDMuSGVyby5RdWVzdFJld2FyZEhpc3RvcnlFbnRyeQ==");
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_D3_Hero_Digest__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::D3.Hero.Digest, global::D3.Hero.Digest.Builder>(internal__static_D3_Hero_Digest__Descriptor,
                new string[] { "Version", "HeroId", "HeroName", "GbidClass", "Level", "PlayerFlags", "VisualEquipment", "QuestHistory", "LastPlayedAct", "HighestUnlockedAct", "LastPlayedDifficulty", "HighestUnlockedDifficulty", "LastPlayedQuest", "LastPlayedQuestStep", "TimePlayed", "HighestCompletedDifficulty", "CreateTime", "LastPlayedTime", });
        ...
        internal__static_D3_Hero_QuestRewardHistoryList__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::D3.Hero.QuestRewardHistoryList, global::D3.Hero.QuestRewardHistoryList.Builder>(internal__static_D3_Hero_QuestRewardHistoryList__Descriptor,
                new string[] { "QuestRewardHistoryProp", });
        return null;
      };
  ...
  public sealed partial class Digest : pb::GeneratedMessage<Digest, Digest.Builder> {
    ...
    public const int LastPlayedTimeFieldNumber = 19;
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasVersion) {
        output.WriteUInt32(1, field_names[16], Version);
      }
      if (hasHeroId) {
        output.WriteMessage(2, field_names[2], HeroId);
      }
      if (hasHeroName) {
        output.WriteString(3, field_names[3], HeroName);
      }
      if (hasGbidClass) {
        output.WriteSFixed32(4, field_names[1], GbidClass);
      }
      if (hasLevel) {
        output.WriteSInt32(5, field_names[12], Level);
      }
      if (hasPlayerFlags) {
        output.WriteUInt32(6, field_names[13], PlayerFlags);
      }
      if (hasVisualEquipment) {
        output.WriteMessage(7, field_names[17], VisualEquipment);
      }
      if (questHistory_.Count > 0) {
        output.WriteMessageArray(8, field_names[14], questHistory_);
      }
      if (hasLastPlayedAct) {
        output.WriteSInt32(10, field_names[7], LastPlayedAct);
      }
      if (hasHighestUnlockedAct) {
        output.WriteSInt32(11, field_names[5], HighestUnlockedAct);
      }
      if (hasLastPlayedDifficulty) {
        output.WriteSInt32(12, field_names[8], LastPlayedDifficulty);
      }
      if (hasHighestUnlockedDifficulty) {
        output.WriteSInt32(13, field_names[6], HighestUnlockedDifficulty);
      }
      if (hasLastPlayedQuest) {
        output.WriteSFixed32(14, field_names[9], LastPlayedQuest);
      }
      if (hasLastPlayedQuestStep) {
        output.WriteSInt32(15, field_names[10], LastPlayedQuestStep);
      }
      if (hasTimePlayed) {
        output.WriteUInt32(16, field_names[15], TimePlayed);
      }
      if (hasHighestCompletedDifficulty) {
        output.WriteSInt32(17, field_names[4], HighestCompletedDifficulty);
      }
      if (hasCreateTime) {
        output.WriteUInt32(18, field_names[0], CreateTime);
      }
      if (hasLastPlayedTime) {
        output.WriteUInt32(19, field_names[11], LastPlayedTime);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    public override int SerializedSize {
      get {
        ...
        if (hasCreateTime) {
          size += pb::CodedOutputStream.ComputeUInt32Size(18, CreateTime);
        }
        if (hasLastPlayedTime) {
          size += pb::CodedOutputStream.ComputeUInt32Size(19, LastPlayedTime);
        }
        size += UnknownFields.SerializedSize;
        memoizedSerializedSize = size;
        return size;
  ...
  public sealed partial class SavedData : pb::GeneratedMessage<SavedData, SavedData.Builder> {
    ...
    public const int SkillSlotEverAssignedFieldNumber = 15;
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasLastLevelTime) {
        output.WriteUInt32(6, field_names[4], LastLevelTime);
      }
      if (hasLearnedLore) {
        output.WriteMessage(7, field_names[5], LearnedLore);
      }
  ...
  public sealed partial class QuestHistoryList : pb::GeneratedMessage<QuestHistoryList, QuestHistoryList.Builder> {
    ...
    private static readonly string[] _questHistoryListFieldNames = new string[] { "quest_historyProp" };
    ...
    public const int QuestHistoryPropFieldNumber = 1;
    private pbc::PopsicleList<global::D3.Hero.QuestHistoryEntry> questHistoryProp_ = new pbc::PopsicleList<global::D3.Hero.QuestHistoryEntry>();
    public scg::IList<global::D3.Hero.QuestHistoryEntry> QuestHistoryPropList {
      get { return questHistoryProp_; }
    }
    public int QuestHistoryPropCount {
      get { return questHistoryProp_.Count; }
    }
    public global::D3.Hero.QuestHistoryEntry GetQuestHistoryProp(int index) {
      return questHistoryProp_[index];
    }
    
    public override bool IsInitialized {
      get {
        foreach (global::D3.Hero.QuestHistoryEntry element in QuestHistoryPropList) {
          if (!element.IsInitialized) return false;
        }
        return true;
      }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (questHistoryProp_.Count > 0) {
        output.WriteMessageArray(1, field_names[0], questHistoryProp_);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    private QuestHistoryList MakeReadOnly() {
      questHistoryProp_.MakeReadOnly();
      return this;
    }
    ...
    public sealed partial class Builder : pb::GeneratedBuilder<QuestHistoryList, Builder> {
      ...
      public override Builder MergeFrom(QuestHistoryList other) {
        ...
        PrepareBuilder();
        if (other.questHistoryProp_.Count != 0) {
          result.questHistoryProp_.Add(other.questHistoryProp_);
        }
        this.MergeUnknownFields(other.UnknownFields);
        return this;
      }
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.ReadMessageArray(tag, field_name, result.questHistoryProp_, global::D3.Hero.QuestHistoryEntry.DefaultInstance, extensionRegistry);
              break;
            }
          }
        }
      ...
      public pbc::IPopsicleList<global::D3.Hero.QuestHistoryEntry> QuestHistoryPropList {
        get { return PrepareBuilder().questHistoryProp_; }
      }
      public int QuestHistoryPropCount {
        get { return result.QuestHistoryPropCount; }
      }
      public global::D3.Hero.QuestHistoryEntry GetQuestHistoryProp(int index) {
        return result.GetQuestHistoryProp(index);
      }
      public Builder SetQuestHistoryProp(int index, global::D3.Hero.QuestHistoryEntry value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.questHistoryProp_[index] = value;
        return this;
      }
      public Builder SetQuestHistoryProp(int index, global::D3.Hero.QuestHistoryEntry.Builder builderForValue) {
        pb::ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
        PrepareBuilder();
        result.questHistoryProp_[index] = builderForValue.Build();
        return this;
      }
      public Builder AddQuestHistoryProp(global::D3.Hero.QuestHistoryEntry value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.questHistoryProp_.Add(value);
        return this;
      }
      public Builder AddQuestHistoryProp(global::D3.Hero.QuestHistoryEntry.Builder builderForValue) {
        pb::ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
        PrepareBuilder();
        result.questHistoryProp_.Add(builderForValue.Build());
        return this;
      }
      public Builder AddRangeQuestHistoryProp(scg::IEnumerable<global::D3.Hero.QuestHistoryEntry> values) {
        PrepareBuilder();
        result.questHistoryProp_.Add(values);
        return this;
      }
      public Builder ClearQuestHistoryProp() {
        PrepareBuilder();
        result.questHistoryProp_.Clear();
        return this;
      }
    }
  ...
  public sealed partial class QuestRewardHistoryList : pb::GeneratedMessage<QuestRewardHistoryList, QuestRewardHistoryList.Builder> {
    ...
    private static readonly string[] _questRewardHistoryListFieldNames = new string[] { "quest_reward_historyProp" };
    ...
    public const int QuestRewardHistoryPropFieldNumber = 1;
    private pbc::PopsicleList<global::D3.Hero.QuestRewardHistoryEntry> questRewardHistoryProp_ = new pbc::PopsicleList<global::D3.Hero.QuestRewardHistoryEntry>();
    public scg::IList<global::D3.Hero.QuestRewardHistoryEntry> QuestRewardHistoryPropList {
      get { return questRewardHistoryProp_; }
    }
    public int QuestRewardHistoryPropCount {
      get { return questRewardHistoryProp_.Count; }
    }
    public global::D3.Hero.QuestRewardHistoryEntry GetQuestRewardHistoryProp(int index) {
      return questRewardHistoryProp_[index];
    }
    
    public override bool IsInitialized {
      get {
        foreach (global::D3.Hero.QuestRewardHistoryEntry element in QuestRewardHistoryPropList) {
          if (!element.IsInitialized) return false;
        }
        return true;
      }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (questRewardHistoryProp_.Count > 0) {
        output.WriteMessageArray(1, field_names[0], questRewardHistoryProp_);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    private QuestRewardHistoryList MakeReadOnly() {
      questRewardHistoryProp_.MakeReadOnly();
      return this;
    }
    ...
    public sealed partial class Builder : pb::GeneratedBuilder<QuestRewardHistoryList, Builder> {
      ...
      public override Builder MergeFrom(QuestRewardHistoryList other) {
        ...
        PrepareBuilder();
        if (other.questRewardHistoryProp_.Count != 0) {
          result.questRewardHistoryProp_.Add(other.questRewardHistoryProp_);
        }
        this.MergeUnknownFields(other.UnknownFields);
        return this;
      }
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.ReadMessageArray(tag, field_name, result.questRewardHistoryProp_, global::D3.Hero.QuestRewardHistoryEntry.DefaultInstance, extensionRegistry);
              break;
            }
          }
        }
      ...
      public pbc::IPopsicleList<global::D3.Hero.QuestRewardHistoryEntry> QuestRewardHistoryPropList {
        get { return PrepareBuilder().questRewardHistoryProp_; }
      }
      public int QuestRewardHistoryPropCount {
        get { return result.QuestRewardHistoryPropCount; }
      }
      public global::D3.Hero.QuestRewardHistoryEntry GetQuestRewardHistoryProp(int index) {
        return result.GetQuestRewardHistoryProp(index);
      }
      public Builder SetQuestRewardHistoryProp(int index, global::D3.Hero.QuestRewardHistoryEntry value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.questRewardHistoryProp_[index] = value;
        return this;
      }
      public Builder SetQuestRewardHistoryProp(int index, global::D3.Hero.QuestRewardHistoryEntry.Builder builderForValue) {
        pb::ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
        PrepareBuilder();
        result.questRewardHistoryProp_[index] = builderForValue.Build();
        return this;
      }
      public Builder AddQuestRewardHistoryProp(global::D3.Hero.QuestRewardHistoryEntry value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.questRewardHistoryProp_.Add(value);
        return this;
      }
      public Builder AddQuestRewardHistoryProp(global::D3.Hero.QuestRewardHistoryEntry.Builder builderForValue) {
        pb::ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
        PrepareBuilder();
        result.questRewardHistoryProp_.Add(builderForValue.Build());
        return this;
      }
      public Builder AddRangeQuestRewardHistoryProp(scg::IEnumerable<global::D3.Hero.QuestRewardHistoryEntry> values) {
        PrepareBuilder();
        result.questRewardHistoryProp_.Add(values);
        return this;
      }
      public Builder ClearQuestRewardHistoryProp() {
        PrepareBuilder();
        result.questRewardHistoryProp_.Clear();
        return this;
      }
    }
